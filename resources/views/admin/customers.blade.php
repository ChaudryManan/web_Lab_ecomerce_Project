...
<div class="sidebar">
    <div class="p-3">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="/admin/customers"><i class="fas fa-users"></i>Customers</a>
...
<div class="main-content">
    <div class="dashboard-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <h1 class="h2 mb-1"><i class="fas fa-users me-2"></i>Customer Management</h1>
                <p class="text-muted mb-0">View all registered customers.</p>
            </div>
                    ...
                    <tbody>
                        @forelse($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-primary">{{ $customer->orders->count() }} order(s)</span>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    ...
                                    <p class="text-muted">No customers with orders yet.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
